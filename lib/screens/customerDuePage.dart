...
class CustomerDuePage extends StatefulWidget {
  final String token;
  CustomerDuePage(this.token);
  @override
  _CustomerDuePageState createState() => _CustomerDuePageState(token);
}

class _CustomerDuePageState extends State<CustomerDuePage> {
  final String token;
  _CustomerDuePageState(this.token);
  @override
            ...
            new Expanded(
              ...
              child: new Column(
                  ...
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                      child: FlatButton(color: Colors.black, onPressed: (){}, child: Text('Pay Now',style: TextStyle(color:Colors.white)) ),
                    )
                  ]),
            ),
            new Expanded(
