...
class PendingCreditTransactionPage extends StatefulWidget {
  final String token;
  PendingCreditTransactionPage(this.token);
  @override
  _PendingCreditTransactionPageState createState() => _PendingCreditTransactionPageState(token);
}

class _PendingCreditTransactionPageState extends State<PendingCreditTransactionPage> {
  final String token;
  _PendingCreditTransactionPageState(this.token);
  @override
            ...
            new Expanded(
              ...
              child: new Column(
                  ...
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                      child: FlatButton(color: Colors.black, onPressed: (){}, child: Text('Accept',style:TextStyle(color:Colors.white))),
                    )
                  ]),
            ),
            new Expanded(
              ...
              child: new Column(
                ...
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                    child: FlatButton(color: Colors.black, onPressed: (){}, child: Text('Decline',style:TextStyle(color:Colors.white))),
                  )
                ],
              ),
            ),
